...
public final class L2NpcTemplate extends L2CharTemplate
{
	...
	public final int     ischar;
    public final int     charrace;
    public final int     charclass;
    public final int     charhair;
    public final int     charface;
    ...
    */
	...
	public L2NpcTemplate(StatsSet set)
	{
        ...
        head     = set.getInteger("head");
        pant     = set.getInteger("pant");
        boot     = set.getInteger("boot");
        glove     = set.getInteger("glove");
        ischar     = set.getInteger("ischar");
        charrace     = set.getInteger("charrace");
        charclass    = set.getInteger("charclass");
        charface     = set.getInteger("charface");
        charhair     = set.getInteger("charhair");
