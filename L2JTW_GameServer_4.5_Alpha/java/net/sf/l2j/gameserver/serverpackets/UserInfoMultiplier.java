 ...
 */
public class UserInfoMultiplier extends L2GameServerPacket
{
     ...
     * @param _characters
     */
    public UserInfoMultiplier(L2PcInstance character)
    {
	...
	protected final void writeImpl()
    {
        ...
        // All disable due to useless packet for updating Multiplier
        ...
        if (_activeChar.getAppearance().getInvisible() && _activeChar.isGM()) title = "Áô§Îª¬ºA";
