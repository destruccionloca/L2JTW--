...
public class Castle
{
 ...
 // =========================================================
	...
	public void setOwner(L2Clan clan)
	{
	    ...
	    if (getOwnerId() > 0 && (clan == null || clan.getClanId() != getOwnerId()))
	    {
			...
			if (oldOwner != null)
			{
        		...
        		new Announcements().announceToAll(oldOwner.getName() + " 失去了 " + getName() + " 城堡!");
			}							
	    }
    ...
    public void setTaxPercent(L2PcInstance activeChar, int taxPercent)
    {
        ...
        {
            activeChar.sendMessage("稅率數值只能在 0 至 "+maxTax+" 之間.");
            return;
        }
        
        setTaxPercent(taxPercent);
        activeChar.sendMessage(getName() + " 城堡更改稅率為 " + taxPercent + "%.");
    }
