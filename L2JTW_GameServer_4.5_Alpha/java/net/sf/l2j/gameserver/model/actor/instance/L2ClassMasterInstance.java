...
public final class L2ClassMasterInstance extends L2FolkInstance
{
	...
	public void onAction(L2PcInstance player)
	{
		...
		else
		{
			...
			{			
				for (int i = 0; i < SECONDN_CLASS_IDS.length; i++)
				{
					if (classId.getId() == SECONDN_CLASS_IDS[i])
					{
                        ...
                        sb.append("<tr><td><center>"+CharTemplateTable.getClassNameById(player.getClassId().getId())+" 大師:</center></td></tr>");
                        sb.append("<tr><td><br></td></tr>");
                        sb.append("<tr><td><a action=\"bypass -h npc_"+getObjectId()+"_change_class "+(88+i)+"\">進階為 "+CharTemplateTable.getClassNameById(88+i)+"</a></td></tr>");
                        sb.append("<tr><td><br></td></tr>");
                        sb.append("<tr><td><a action=\"bypass -h npc_"+getObjectId()+"_upgrade_hatchling\">進化幼龍為座龍</a></td></tr>");
			...
			else 
			{
				...
				{
					case 1:
						sb.append("等你20級再回來找我轉換你的職業吧.<br>");
						break;
					case 2:
						sb.append("等你40級再回來找我轉換你的職業吧.<br>");
						break;
					case 3:
						sb.append("已經沒有任何職業可以幫你轉換了.<br>");
						break;
				}
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		else if(command.startsWith("change_class"))
		{
            ...
            TextBuilder sb = new TextBuilder();
            sb.append("<html><body>");
            sb.append("你成為了 <font color=\"LEVEL\">" + CharTemplateTable.getClassNameById(player.getClassId().getId()) + "</font>.");
            sb.append("</body></html>");
