...
public class AttackableKnownList extends NpcKnownList
{
    ...
    public int getDistanceToWatchObject(L2Object object)
    {
        ...
        if (getActiveChar().getIsChaos() > getActiveChar().getAggroRange())
            return getActiveChar().getIsChaos();
            
        if (getActiveChar().getEnemyRange() > getActiveChar().getAggroRange())
            return getActiveChar().getEnemyRange();
