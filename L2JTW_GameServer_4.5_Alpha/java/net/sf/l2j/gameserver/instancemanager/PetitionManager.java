...
public final class PetitionManager
{
	...
	private class Petition
	{
		...
		public boolean endPetitionConsultation(PetitionState endState)
		{
			...
			if (getResponder() != null && getResponder().isOnline() == 1)
			{
				...
				{
					getPetitioner().sendMessage("您的訴求被取消,請稍候再嘗試.");
				}
				else 
				{
	...
	public void sendPendingPetitionList(L2PcInstance activeChar)
	{
		...
		"<center><font color=\"LEVEL\">目前訴求</font><br><table width=\"300\">");
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd MMM HH:mm z");
		
		if (getPendingPetitionCount() == 0)
			htmlContent.append("<tr><td colspan=\"4\">目前沒有訴求.</td></tr>");
		else
			htmlContent.append("<tr><td></td><td><font color=\"999999\">人物</font></td>" +
			"<td><font color=\"999999\">形式</font></td><td><font color=\"999999\">送出</font></td></tr>");
		...
		htmlContent.append("</table><br><button value=\"重新整理\" action=\"bypass -h admin_view_petitions\" width=\"50\" " +
		                   "height=\"15\" back=\"sek.cbui94\" fore=\"sek.cbui92\"><br><button value=\"返回\" action=\"bypass -h admin_admin\" " +
	...
	public void viewPetition(L2PcInstance activeChar, int petitionId)
	{
		...
		htmlContent.append("時間: " + dateFormat.format(new Date(currPetition.getSubmitTime())) + "<br1>");
		htmlContent.append("人物: " + currPetition.getPetitioner().getName() + "<br1>");
		htmlContent.append("形式: " + currPetition.getTypeAsString() + "<br>" + currPetition.getContent() + "<br>");
		htmlContent.append("<center><button value=\"接受\" action=\"bypass -h admin_accept_petition " + currPetition.getId() + "\"" +
		"width=\"50\" height=\"15\" back=\"sek.cbui94\" fore=\"sek.cbui92\"><br1>");
		htmlContent.append("<button value=\"拒絕\" action=\"bypass -h admin_reject_petition " + currPetition.getId() + "\" " +
		"width=\"50\" height=\"15\" back=\"sek.cbui94\" fore=\"sek.cbui92\"><br>");
		htmlContent.append("<button value=\"返回\" action=\"bypass -h admin_view_petitions\" width=\"40\" height=\"15\" back=\"sek.cbui94\" " +
