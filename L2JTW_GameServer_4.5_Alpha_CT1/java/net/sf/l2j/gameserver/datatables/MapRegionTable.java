...
public class MapRegionTable
{
	...
	public int getAreaCastle(L2Character activeChar)
	{
        ...
        case 19: castle = 5; break; //Kamael Village 
     	case 20: castle = 6; break; //South of Wastelands Camp 
     	case 21: castle = 8; break; //Fantasy Island 
	...
	public String getAreaName(L2Character activeChar)
	{
		...
		switch (areaId)
		{
		case 0:  AreaName = "¥j¾|¤B"; break;//Talking Island Village
        case 1:  AreaName = "¼Ú·ç"; break; //Elven Village
        case 2:  AreaName = "¼Ú·ç"; break; //Dark Elven Village
        case 3:  AreaName = "­×¥[¯S"; break; //Orc Village
        case 4:  AreaName = "­×¥[¯S"; break; //Dwarven Village
        case 5:  AreaName = "¥j¾|¤B"; break; //Town of Gludio
        case 6:  AreaName = "¥j¾|¤B"; break; //Gludin Village
        case 7:  AreaName = "¥j¾|¤B"; break; //Town of Dion
        case 8:  AreaName = "©_©¥"; break; //Town of Giran
        case 9:  AreaName = "¼Ú·ç"; break; //Town of Oren
        case 10: AreaName = "¨È¤B"; break; //Town of Aden
        case 11: AreaName = "¨È¤B"; break; //Hunters Village
        case 12: AreaName = "©_©¥"; break; //Giran Harbor
        case 13: AreaName = "¦]¯Ç±o§Q"; break; //Heine
        case 14: AreaName = "¾|¦]"; break; //Rune Township
        case 15: AreaName = "°ª¹F¯S"; break; //Town of Goddard
        case 16: AreaName = "­×¥[¯S"; break; //Town of Shuttgart
        case 17: AreaName = "¼Ú·ç"; break; //Ivory Tower
        case 18: AreaName = "¾|¦]"; break; //Primeval Isle Wharf
        case 19: AreaName = "¨È¤B"; break; //Kamael Village 
     	case 20: AreaName = "¦]¯Ç±o§Q"; break; //South of Wastelands Camp 
     	case 21: AreaName = "¾|¦]"; break; //Fantasy Island 
        default: AreaName = "¨È¤B"; break; //Town of Aden
		}
		return AreaName;
	}
    ...
    public String getClosestTownName(L2Character activeChar)
    {
        ...
        switch (nearestTownId)
        {
            ...
            case 0: nearestTown = "»¡¸Ü¤§®q§ø²ø"; break;
            case 1: nearestTown = "ºëÆF§ø²ø"; break;
            case 2: nearestTown = "¶Â·tºëÆF§ø²ø"; break;
            case 3: nearestTown = "¥bÃ~¤H§ø²ø"; break;
            case 4: nearestTown = "¸G¤H§ø²ø"; break;
            case 5: nearestTown = "¥j¾|¤B«°Âí"; break;
            case 6: nearestTown = "¥j¾|¤B§ø²ø"; break;
            case 7: nearestTown = "¨f®¦«°Âí"; break;
            case 8: nearestTown = "©_©¥«°Âí"; break;
            case 9: nearestTown = "¼Ú·ç«°Âí"; break;
            case 10: nearestTown = "¨È¤B«°Âí"; break;
            case 11: nearestTown = "Ây¤H§ø²ø"; break;
            case 12: nearestTown = "©_©¥´ä¤f"; break;
            case 13: nearestTown = "®ü­µ«°Âí"; break;
            case 14: nearestTown = "¾|¦]«°Âí"; break;
            case 15: nearestTown = "°ª¹F¯S«°Âí"; break;
            case 16: nearestTown = "­×¥[¯S«°"; break;  ////TODO@ (Check mapregion table)[Luno]
            case 18: nearestTown = "¯«¿Ù®q";break;
            case 19: nearestTown = "îî¤Ñ¨Ï§ø²ø";break;
            default: nearestTown = "¨È¤B«°Âí"; break;
