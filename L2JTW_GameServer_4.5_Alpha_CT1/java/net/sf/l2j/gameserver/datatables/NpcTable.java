...
public class NpcTable
{
	...
	private void restoreNpcData()
	{
		...
		try
		{
            ...
            {
			    PreparedStatement statement10 = con.prepareStatement("SELECT " + L2DatabaseFactory.getInstance().safetyString(new String[] 
			    {"npc_id", "primary_attack","skill_chance","canMove","soulshot","spiritshot","sschance","spschance","ischaos","clan","enemyClan","enemyRange","dodge"}) + " FROM npcAIData ORDER BY npc_id");
	...
	throws Exception
	{
		while (NpcData.next())
		{
            ...
            */
            ...
            npcDat.set("ischar", NpcData.getInt("ischar"));
            npcDat.set("charclass", NpcData.getInt("charclass"));
            npcDat.set("charrace", NpcData.getInt("charrace"));
            npcDat.set("charhair", NpcData.getInt("charhair"));
            npcDat.set("charcolor", NpcData.getInt("charcolor"));
            npcDat.set("charface", NpcData.getInt("charface"));
            npcDat.set("charhero", NpcData.getInt("charhero"));
            npcDat.set("charsex", NpcData.getInt("charsex"));
            npcDat.set("charsoulshot", NpcData.getInt("charsoulshot"));
