...
public class L2Event
{
    ...
    public static void showEventHtml(L2PcInstance player, String objectid)
    {
        try
        {
            ...
            if (L2Event.participatingPlayers.contains(player.getName())) replyMSG.append("<br><center>你已經參加了!</center></body></html>");
            else replyMSG.append("<br><center><button value=\"加入! \" action=\"bypass -h npc_"
                + objectid
    ...
    public static void spawn(L2PcInstance target, int npcid)
    {
        ...
        try
        {
            ...
            spawn.getLastSpawn().setName("活動目標");
