...
//L2JTW addon end ==========================================
    ...
    public void onActionShift(L2GameClient client)
    {
        ...
        if (player.getAccessLevel().isGm())
        {
            ...
            html1.append("<br><center><table><tr><td><button value=\"編輯\" action=\"bypass -h admin_edit_npc " + getTemplate().npcId + "\" width=100 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"><br1></td>");
            html1.append("<td><button value=\"滅亡\" action=\"bypass -h admin_kill\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td><br1></tr>");
            html1.append("<tr><td><button value=\"掉落\" action=\"bypass -h admin_show_droplist " + getTemplate().npcId + "\" width=100 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>");
        ...
        //if (canInteract(player))
        {
            ...
            else if (command.equalsIgnoreCase("TerritoryStatus"))
            {
            	...
            	{ 
            		...
            		{ 
            			html.replace("%territory%", "艾爾摩王國"); 
            		} 
            		else 
            		{ 
            			html.replace("%territory%", "亞丁王國"); 
            		} 
            	} 
            	player.sendPacket(html); 
            }
...
//L2JTW addon end ==========================================
    ...
    public void makeSupportMagic(L2PcInstance player)
    {
        ...
        {
            String content = "<html><body>初學者嚮導：<br>輔助魔法只限於<font color=\"LEVEL\">等級"+ highestLevel +"以下的角色</font>。</body></html>";
            insertObjectIdAndShowChatWindow(player, content);
            return;
        }
