        ...
        else
        {
            ...
            if(ptarget!=null)
            {
                if (answer == 1)
                {
                    ...
                    ptarget.sendMessage("結婚要求被 >接受< 了.");
                }
                else
                    ptarget.sendMessage("結婚要求被 >拒絕< 了!");
            }
        }
    }
...
// Addon End ==================================================
	...
	public void setChatBanned(boolean isBanned)
	{
		...
		if (isChatBanned())
			sendMessage("目前為禁言狀態,有任何相關問題請聯絡GM協助.");
		else
		{
			sendMessage("禁言狀態解除.");
