...
//   =============================================================================================================================================================
	...
	{
		if (this == null || player == null || player == this || getAttackByList().contains(player)) return;
	...
	public void doCast(L2Skill skill)
	{
        ...
        if ((skill.getSkillType() == SkillType.BLOW) && (skill.getCondition() == 16 || skill.getCondition() == 8))
        {
            ...
            if (!isInFrontOfTarget() && skill.getCondition() == 16)
            {                            
                critBonus = 60;
            }
            else if(!isInFrontOfTarget() && skill.getCondition() == 8)
            {
                critBonus = 70;
            }
            else if(isInFrontOfTarget() && skill.getCondition() == 8)
	...
	*/
	...
	public boolean isAttackingDisabled() { return isStunned() || isImmobileUntilAttacked() || isSleeping() || _attackEndTime > GameTimeController.getGameTicks() || isFakeDeath() || isParalyzed() || isPhysicalAttackMuted() || _castEndTime > GameTimeController.getGameTicks(); }
