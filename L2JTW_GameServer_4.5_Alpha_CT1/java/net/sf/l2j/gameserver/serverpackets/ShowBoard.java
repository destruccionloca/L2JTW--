...
public class ShowBoard extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeS("bypass _bbshome"); // 首頁
		writeS("bypass _bbsgetfav"); // 書籤
		writeS("bypass _bbsloc"); // 領地連結
		writeS("bypass _bbsclan"); // 血盟
		writeS("bypass _bbsmemo"); // 備忘錄
		writeS("bypass _bbsmail"); // 郵件
		writeS("bypass _bbsfriends"); // 好友管理
		writeS("bypass bbs_add_fav"); // 加入書籤
		if (!_id.equals("1002"))
		{
