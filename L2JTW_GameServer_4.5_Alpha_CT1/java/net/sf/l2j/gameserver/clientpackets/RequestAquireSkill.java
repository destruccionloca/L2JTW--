	...
	protected void runImpl()
	{
		...
		switch (_skillType)
		{
			case 0:
			{
				...
				{
					player.sendMessage("嘗試學習無法學習的技能");
					Util.handleIllegalPlayerAction(player, "玩家 " + player.getName() + " 嘗試學習不該學習的技能!!!", IllegalPlayerAction.PUNISH_KICK);
					return;
				}
			...
			case 2:
			{
				if (!player.isClanLeader())
				{
					...
					player.sendMessage("此功能只有血盟盟主可以使用.");
					return;
				}
