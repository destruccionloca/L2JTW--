			...
			try
			{
				...
				switch (_requestedPointType)
				{
					case 1: // to clanhall
						...
						{
							//cheater
							activeChar.sendMessage("跋办礚猭秈︽確!");
	...
	protected void runImpl()
	{
		...
		if (castle != null && castle.getSiege().getIsInProgress())
		{
			...
			if (activeChar.getClan() != null && castle.getSiege().checkIsAttacker(activeChar.getClan()))
			{
				...
				sm.addString("SYS");
				sm.addString("盢 " + castle.getSiege().getAttackerRespawnDelay()/1000 + " 確");
			...
			else
			{
				...
				sm.addString("SYS");
				sm.addString("盢 " + castle.getSiege().getDefenderRespawnDelay()/1000 + " 確");
				activeChar.sendPacket(sm);
			}
			sm = null;
			return;
