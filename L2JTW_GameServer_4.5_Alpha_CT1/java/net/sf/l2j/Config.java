...
public final class Config
{
    ...
    public static boolean ALT_GAME_PENALTY;
    public static int ALT_GAME_EXP_Level;
    public static boolean ALLOW_3RD_CLASS;

    /** Turn off the stupid sevensign stuff... they keep buff like hell.... packet send way too many... */
    public static boolean Preacher_Spawns;
    public static boolean Orator_Spawns;
    
    /** Limite the player attack speed to prevent exploit**/
    public static int ALT_GAME_ATKSPD;
    ...
    public static void load()
    {
        if(Server.serverMode == Server.MODE_GAMESERVER)
        {
            ...
            try
            {
                ...
                ALT_GAME_EXP                   						= Boolean.parseBoolean(altSettings.getProperty("AltGameExp", "False"));
                ALT_GAME_PENALTY                   						= Boolean.parseBoolean(altSettings.getProperty("AltGamePenalty", "False"));
                ALT_GAME_EXP_Level                   				= Integer.parseInt(altSettings.getProperty("AltGameExpLevel", "50"));
                Orator_Spawns                   						= Boolean.parseBoolean(altSettings.getProperty("OratorSpawns", "False"));
                Preacher_Spawns                   						= Boolean.parseBoolean(altSettings.getProperty("PreacherSpawns", "False"));
	        ...
	        try
	        {
                ...
                AI_FIGHTER_HATE_MULTIPLICATOR_RAID = Integer.parseInt(aiSettings.getProperty("FighterHateMultiRaid"));
                AI_FIGHTER_HATE_MULTIPLICATOR_NORM = Integer.parseInt(aiSettings.getProperty("FighterHateMultiNorm"));
	        }
	        catch (Exception e)
	        {
	        	//e.printStackTrace();
    ...
    public static boolean setParameterValue(String pName, String pValue)
    {
        ...
        else if (pName.equalsIgnoreCase("BlessedEnchantChance")) BLESSED_ENCHANT_CHANCE = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("CrystalEnchantChance")) CRYSTAL_ENCHANT_CHANCE = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("SafetyEnchantMax")) SAFETY_ENCHANT_MAX = Integer.parseInt(pValue);
        ...
        else if (pName.equalsIgnoreCase("TimeInADayOfOpenADoor")) TIME_IN_A_DAY_OF_OPEN_A_DOOR = Integer.parseInt(pValue);
        ...
        else if (pName.equalsIgnoreCase("RandomIntervalOfSailrenSpawn")) FWS_RANDOMINTERVALOFSAILRENSPAWN = Integer.parseInt(pValue);
        ...
        else if (pName.equalsIgnoreCase("FixIntervalOfAntharas")) FWA_FIXINTERVALOFANTHARAS = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("RandomIntervalOfAntharas")) FWA_RANDOMINTERVALOFANTHARAS = Integer.parseInt(pValue);
        ...
        else if (pName.equalsIgnoreCase("FixIntervalOfValakas")) FWV_FIXINTERVALOFVALAKAS = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("RandomIntervalOfValakas")) FWV_RANDOMINTERVALOFVALAKAS = Integer.parseInt(pValue);
