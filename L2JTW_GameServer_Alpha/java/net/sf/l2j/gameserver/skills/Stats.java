...
public enum Stats {
	...
	public static Stats valueOfXml(String name)
	{
        ...
        if (name == "gainHp"   ) return HEAL_HP_RATE;
        ...
        if (name == "reflectStance"   ) return REFLECT_STANCE;
        ...
        if (name == "poleAtkAngle"      ) return POLE_ATTACK_ANGLE;
        if (name == "shieldDefAngle"    ) return SHIELD_DEFENCE_ANGLE;
        if (name == "multifaceAtkAngle" ) return MULTIFACE_ATTACK_ANGLE;
        ...
        if (name == "critbonus"  ) return CRIT_BONUS;
        if (name == "critpenalty"  ) return CRIT_PENALTY;
        if (name == "critpowerbonus"  ) return CRIT_POWER_BONUS;
        if (name == "critpowerpenalty"  ) return CRIT_POWER_PENALTY;
