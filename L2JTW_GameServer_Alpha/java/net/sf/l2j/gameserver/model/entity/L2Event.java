...
public class L2Event
{
    ...
    public static LinkedList<String> participatingPlayers = new LinkedList<String>();
    public static HashMap<Integer, LinkedList<String>> players = new HashMap<Integer, LinkedList<String>>();
    public static int id = 12760;
    public static LinkedList<String> npcs = new LinkedList<String>();
    public static boolean active = false;
    public static HashMap<String, EventData> connectionLossData = new HashMap<String, EventData>();
    ...
    public static void showEventHtml(L2PcInstance player, String objectid)
    {
        try
        {
            ...
            replyMSG.append("<center><font color=\"LEVEL\">" + eventName + "</font><font color=\"FF0000\">" + inbr.readLine() + "</font></center><br>");
            
            replyMSG.append("<br>" + inbr.readLine());
            if(L2Event.participatingPlayers.contains(player.getName())) replyMSG.append("<br><center>你已經在活動名單內 !!</center></body></html>");
            else replyMSG.append("<br><center><button value=\"參與活動\" action=\"bypass -h npc_" + objectid + "_event_participate\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center></body></html>");
