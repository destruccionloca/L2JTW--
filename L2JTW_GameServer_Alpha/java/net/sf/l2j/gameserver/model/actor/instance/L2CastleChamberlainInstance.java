...
public class L2CastleChamberlainInstance extends L2FolkInstance
{
		...
		else if (condition == Cond_Owner)
		{
			...
			else if(actualCommand.equalsIgnoreCase("manage_vault"))
			{
	            ...
	            else
	            {
			    	...
			    	msg.append("<tr><td><a action=\"bypass -h npc_%objectId%_manage_vault deposit\">放置物品</a></td></tr>");
			    	msg.append("<tr><td><a action=\"bypass -h npc_%objectId%_manage_vault withdraw\">取出物品</a></td></tr>");
			    	msg.append("</table>");
	        ...
	        else if(actualCommand.equalsIgnoreCase("tax_set")) // tax rates control
	        {
	        	...
	        	msg.append("稅率: " + getCastle().getTaxPercent() + "%<br>");
	        	msg.append("<table>");
	        	msg.append("<tr>");
	        	msg.append("<td>更改:</td>");
	        	msg.append("<td><edit var=\"value\" width=40><br>");
	        	msg.append("<button value=\"確認\" action=\"bypass -h npc_%objectId%_tax_set $value\" width=80 height=15></td>");
	        	msg.append("</tr>");
	        	msg.append("</table>");
	        	msg.append("</center>");
	        	msg.append("</body></html>");
    ...
    private String pageEditManor(int crop, int current)
    {
        ...
        text += "<tr><td>Crop</td><td>方案[1]</td><td>方案[2]</td></tr>";
