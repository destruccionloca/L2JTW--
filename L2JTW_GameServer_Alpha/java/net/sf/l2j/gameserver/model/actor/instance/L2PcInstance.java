...
//	public boolean isInCraftMode() { return (getPrivateStoreType() == STORE_PRIVATE_MANUFACTURE); }
	...
	public void rewardSkills()
	{
        ...
        if (Config.AUTO_LEARN_SKILLS) {
            ...
            this.sendMessage("學習了 " + skillCounter + " 個技能.");
        }
...
*/            
	...
	public void removeLink(WayPointNode target)
	{
		if (getSelectedNode() != null)
		{
			...
			{
				sendPacket(SystemMessage.sendString("目標不是路徑連接點"));
			}
		}
	}
...
//		if (Config.DEVELOPER) System.out.println("Move Ticks:" + (gameTicks - m._moveTimestamp) + ", distPassed:" + distPassed + ", distFraction:" + distFraction);
    ...
    {   
        ...
        {
            //abort fishing
            this.sendMessage("魚竿未朝向有水的區域");
            return;
        }
        
        L2ItemInstance lure = this.getInventory().getPaperdollItem(Inventory.PAPERDOLL_LHAND);
        
        this.SetLure(lure);
        L2ItemInstance lure2 =  this.getInventory().destroyItem("Consume",  this.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_LHAND), 1,  this, null);
