...
public final class L2VillageMasterInstance extends L2FolkInstance
{
        ...
        { 
            ...
            switch (cmdChoice)
            {
                ...
                case 5: // Change Class - Action
                    ...
                    content.append("副職業轉換:<br>你現在的副職業是 <font color=\"LEVEL\">" +
                ...
                case 7: // Change Subclass - Action
                    ...
                    if (player.modifySubClass(paramOne, paramTwo))
                    {
                        ...
                        content.append("轉換副職業:<br>副職業轉換為 <font color=\"LEVEL\">" 
    ...
    public void levelUpClan(L2PcInstance player, int clanId)
    {
        ...
        if (!player.isClanLeader())
        {
            ...
            sm.addString("SYS");
            sm.addString("單獨血盟盟主可以升級血盟"); //i was too lazy to check if such a sysmsg already exists
            player.sendPacket(sm);
            return;
        }
