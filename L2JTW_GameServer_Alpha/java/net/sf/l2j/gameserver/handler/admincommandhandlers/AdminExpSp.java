...
public class AdminExpSp implements IAdminCommandHandler {
	...
	private void addExpSp(L2PcInstance activeChar)
	{
        ...
        replyMSG.append("<center>人物 <font color=\"LEVEL\">" + player.getName() + "</font></center>");
		replyMSG.append("<table width=270>");
        replyMSG.append("<tr><td>等級: " + player.getLevel() + "</td></tr>");
		replyMSG.append("<tr><td>職業: " + player.getTemplate().className + "</td></tr>");
		replyMSG.append("<tr><td>EXP: " + player.getExp() + "</td></tr>");
		replyMSG.append("<tr><td>SP : " + player.getSp() + "</td></tr></table>"); 
		replyMSG.append("<table width=270><tr><td>注意:存取的時候必須兩項都要填入</td></tr>");
		replyMSG.append("<tr><td>如果不想修改到請以0來代替.</td></tr></table><br>");
		...
		replyMSG.append("<td>&nbsp;<center><button value=\"增加\" action=\"bypass -h admin_add_exp_sp $exp_to_add $sp_to_add\" width=50 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center></td>");
		replyMSG.append("<td>&nbsp;<center><button value=\"移除\" action=\"bypass -h admin_remove_exp_sp $exp_to_add $sp_to_add\" width=70 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></center></td>");
