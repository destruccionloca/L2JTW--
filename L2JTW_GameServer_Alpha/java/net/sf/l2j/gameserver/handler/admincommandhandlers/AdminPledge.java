        ...
        if(command.startsWith("admin_pledge"))
        {
            ...
            if(action.equals("create"))
            {
                try
                {
                    ...
                    if(clan != null)
                    {
                        activeChar.sendMessage("血盟 "+pledgeName+" 創造! 盟主: "+target.getName());
            ...
            else if(action.equals("dismiss"))
            {
                ...
                {
                    activeChar.sendMessage("目標不是血盟盟主或者寫盟不存在");
                    return false;
                }
            ...
            else if(action.equals("setlevel"))
            {
                if (target.getClan() == null || !target.isClanLeader())
                {
                    activeChar.sendMessage("目標不是血盟盟主或者目標不存在");
                    return false;
                }
                ...
                try
                {
                    ...
                    activeChar.sendMessage("設置等級 "+level+" 給血盟 "+target.getClan().getName());
