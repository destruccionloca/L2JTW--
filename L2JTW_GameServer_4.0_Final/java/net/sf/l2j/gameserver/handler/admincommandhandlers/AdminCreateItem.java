...
public class AdminCreateItem implements IAdminCommandHandler {
	...
	private void createItem(L2PcInstance activeChar, int id, int num)
	{
		...
		replyMSG.append("<td width=180><center>物品創造選項</center></td>");
		replyMSG.append("<td width=40><button value=\"返回\" action=\"bypass -h admin_help itemcreation.htm\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		replyMSG.append("</tr></table>");
		replyMSG.append("<br><br>");
		replyMSG.append("<table width=270><tr><td>物品創造完成.<br></td></tr></table>");
